...
__DEFINE__(1648638005095, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1648638005096,"./event-store":1648638005097}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648638005096, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1648638005097, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1648638005096,"./utils":1648638005098}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1648638005098, function(require, module, exports) {
...
return __REQUIRE__(1648638005095);
})()
